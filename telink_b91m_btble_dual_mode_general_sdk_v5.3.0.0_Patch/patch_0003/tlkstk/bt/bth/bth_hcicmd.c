...
int bth_hci_sendWriteExtendedInquiryRspCmd(uint08 fecReq, uint08 *pData, uint08 dataLen)
{
    ...
    tlkapi_array(BTH_HCICMD_DBG_FLAG, BTH_HCICMD_DBG_SIGN, "bth_hci_sendWriteExtendedInquiryRspCmd", buffer, dataLen+1);
    return tlkbt_hci_sendH2cCmd(HCI_WR_EXT_INQ_RSP_CMD_OPCODE, buffer, 240+1);
}
