...
int btp_rfcomm_update_rx_credits_consumed(uint08 rfcHandle, uint08 rx_credits);

int btp_rfcomm_set_channel_credits(uint08 rfcHandle, uint08 rx_credits);
