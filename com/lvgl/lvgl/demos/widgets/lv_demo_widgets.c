...
static lv_chart_series_t * series3;
static lv_chart_series_t * series4;
...
static void analytics_create(lv_obj_t * parent)
{
    ...
    series1 = lv_chart_add_series(chart1, lv_theme_get_color_primary(chart1), LV_CHART_AXIS_PRIMARY_Y);
    lv_chart_set_next_value(chart1, series1, lv_rand(10, 80));
    lv_chart_set_next_value(chart1, series1, lv_rand(10, 80));
    lv_chart_set_next_value(chart1, series1, lv_rand(10, 80));
    lv_chart_set_next_value(chart1, series1, lv_rand(10, 80));
    lv_chart_set_next_value(chart1, series1, lv_rand(10, 80));
    ...
    series2 = lv_chart_add_series(chart2, lv_palette_lighten(LV_PALETTE_GREY, 1), LV_CHART_AXIS_PRIMARY_Y);
    lv_chart_set_next_value(chart2, series2, lv_rand(10, 80));
    lv_chart_set_next_value(chart2, series2, lv_rand(10, 80));
    lv_chart_set_next_value(chart2, series2, lv_rand(10, 80));
    lv_chart_set_next_value(chart2, series2, lv_rand(10, 80));
    lv_chart_set_next_value(chart2, series2, lv_rand(10, 80));
    ...
    series3 = lv_chart_add_series(chart2, lv_theme_get_color_primary(chart1), LV_CHART_AXIS_PRIMARY_Y);
    lv_chart_set_next_value(chart2, series3, lv_rand(10, 80));
    lv_chart_set_next_value(chart2, series3, lv_rand(10, 80));
    lv_chart_set_next_value(chart2, series3, lv_rand(10, 80));
    lv_chart_set_next_value(chart2, series3, lv_rand(10, 80));
    lv_chart_set_next_value(chart2, series3, lv_rand(10, 80));
...
void shop_create(lv_obj_t * parent)
{
    ...
    series4 = lv_chart_add_series(chart3, lv_theme_get_color_primary(chart3), LV_CHART_AXIS_PRIMARY_Y);
    lv_chart_set_next_value(chart3, series4, lv_rand(60, 90));
    lv_chart_set_next_value(chart3, series4, lv_rand(60, 90));
    lv_chart_set_next_value(chart3, series4, lv_rand(60, 90));
    lv_chart_set_next_value(chart3, series4, lv_rand(60, 90));
    lv_chart_set_next_value(chart3, series4, lv_rand(60, 90));
...
static void color_event_cb(lv_event_t * e)
{
    ...
    if(code == LV_EVENT_FOCUSED) {
        ...
        lv_chart_set_series_color(chart1, series1, color);
        lv_chart_set_series_color(chart2, series3, color);
    }
}
...
static void chart_event_cb(lv_event_t * e)
{
    ...
    if(code == LV_EVENT_PRESSED || code == LV_EVENT_RELEASED) {
        ...
        /*Add the faded area before the lines are drawn */
            ...
            const lv_chart_series_t * series = dsc->sub_part_ptr;
            ...
            if(lv_chart_get_pressed_point(obj) == dsc->id) {
                if(lv_chart_get_type(obj) == LV_CHART_TYPE_LINE) {
                    ...
                    dsc->rect_dsc->shadow_color = series->color;
                ...
                if(lv_chart_get_type(obj) == LV_CHART_TYPE_BAR) {
                    ...
                    txt_area.y1 = txt_area.y2 - text_size.y;
                    if(series == lv_chart_get_series_next(obj, NULL)) {
                ...
                lv_draw_rect_dsc_t rect_dsc;
                lv_draw_rect_dsc_init(&rect_dsc);
                rect_dsc.bg_color = series->color;
                rect_dsc.radius = LV_DPX(5);
                lv_draw_rect(dsc->draw_ctx, &rect_dsc, &bg_area);
