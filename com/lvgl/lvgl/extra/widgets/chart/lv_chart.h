 ...
 * @param series      the previous series or NULL to get the first
 ...
 */
void lv_chart_set_cursor_point(lv_obj_t * chart, lv_chart_cursor_t * cursor, lv_chart_series_t * series,
                               uint16_t point_id);
