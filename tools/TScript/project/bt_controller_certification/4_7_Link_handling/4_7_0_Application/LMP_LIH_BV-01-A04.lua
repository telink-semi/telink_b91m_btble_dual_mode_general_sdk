...
--[[
	this function serves to check the testing scenarios that iut as master and lt as slave,
	master Initiate ROLE SWITCH REQ and master receive this request 

]]
   

function LMP_LIH_BV_01_A04(iut_mode,lt_mode,role,Timeout)

	Testcase = "LMP/LIH/BV-01-A04"
	-- iut_mode = "dongle"
	-- lt_mode  = "usb"
	-- role     = "slave"
	OPTIONAL = ALT1
...
for i=1,Total_times do
	...
	flag = LMP_LIH_BV_01_A04("dongle","usb","master",10)
