...
--[[
	...
	slave Initiate ROLE SWITCH REQ and master receive this request 

]]
   

function LMP_LIH_BV_01_A03(iut_mode,lt_mode,role,Timeout)

	Testcase = "LMP/LIH/BV-01-A03"
	-- iut_mode = "dongle"
	-- lt_mode  = "usb"
	-- role     = "slave"
	OPTIONAL = ALT1
...
for i=1,Total_times do
	...
	flag = LMP_LIH_BV_01_A03("dongle","usb","master",10)
