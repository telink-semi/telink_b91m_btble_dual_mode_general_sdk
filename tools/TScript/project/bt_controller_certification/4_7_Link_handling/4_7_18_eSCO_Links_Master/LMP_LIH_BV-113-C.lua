...
function LMP_LIH_BV_113_C(iut_mode,lt_mode,role,Timeout)

    Testcase = "LMP/LIH/BV-113-C"
    -- iut_mode = "dongle"
    -- lt_mode  = "usb"
    OPTIONAL = ALT1
    print("--------------------<<   "..Testcase.."   >>--------------------")
...
--  <= LT:wait for HCI_Synchronous_Connection_Complete Event
    ...
    Packet_Type           = 0x03E0; --EV5  is allowed, SYNC_PACKET_TYPE_EV5_FLAG|SYNC_PACKET_TYPE_NO_EV3_2_FLAG|SYNC_PACKET_TYPE_NO_EV3_3_FLAG|SYNC_PACKET_TYPE_NO_EV5_2_FLAG|SYNC_PACKET_TYPE_NO_EV5_3_FLAG
...
LMP_LIH_BV_113_C("dongle","usb","master",10)