...
function  LMP_LIH_BV_12_C(iut_mode,lt_mode,role,Timeout)

	Testcase = "LMP/LIH/BV-12-C"
	-- iut_mode = "dongle"
	-- lt_mode  = "usb"
	-- role     = "slave"
	OPTIONAL = ALT1
	...
	print("============ IUT unsupported hold mode  =============")


    Max_Interval = 0x7d00
    Min_Interval = 0x0080

    HCI_Hold_Mode(lt_handle_w,lt_mode,iut_Connection_Handle,Max_Interval,Min_Interval)
...
for i=1,Total_times do
	...
	flag = LMP_LIH_BV_12_C("dongle","usb","slave",10)
	if(flag=="Pass") then
		success=success+1
	else
		fail=fail+1
