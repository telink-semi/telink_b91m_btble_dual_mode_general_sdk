...
function  LMP_LIH_BV_35_C(iut_mode,lt_mode,role,Timeout)

	Testcase = "LMP/LIH/BV-35-C"
	-- iut_mode = "dongle"
	-- lt_mode  = "usb"
	-- role     = "slave"
	OPTIONAL = ALT1
	...
	-- <= IUT:HCI_AB_PW_DECR
    HCI_AB_PW_DECR(iut_handle_w,iut_mode)


	-- => IUT:HCI Command Status abevent
	flag,rst_tbl = HCI_Wait_ABEvent_Done(iut_handle_r,iut_mode,"HCI_Abnormal_PW_DECR_Complete",Timeout)
	if(flag~=true) then
		Test_Status="Fail"
		goto Test_Case_End
	end
...
LMP_LIH_BV_35_C("dongle","usb","slave",10)