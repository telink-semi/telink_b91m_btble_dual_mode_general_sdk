...
function LMP_LIH_BV_103_C(iut_mode,lt_mode,role,Timeout)

    Testcase = "LMP/LIH/BV-103-C"
    -- iut_mode = "dongle"
    -- lt_mode  = "usb"
    OPTIONAL = ALT1
    print("--------------------<<   "..Testcase.."   >>--------------------")
    ...
    -- trigger IUT(eagle evk) to initiate the eSCO link setup procedure with LT(csr dongle)
...
LMP_LIH_BV_103_C("dongle","usb","slave",10)