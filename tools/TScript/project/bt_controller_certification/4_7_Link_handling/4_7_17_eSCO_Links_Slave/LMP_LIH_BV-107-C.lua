...
function LMP_LIH_BV_107_C(iut_mode,lt_mode,role,Timeout)

    Testcase = "LMP/LIH/BV-107-C"
    -- iut_mode = "dongle"
    -- lt_mode  = "usb"
    OPTIONAL = ALT1
    print("--------------------<<   "..Testcase.."   >>--------------------")
    ...
    Packet_Type           = 0x03C8;     -- EV3 is allowed, SYNC_PACKET_TYPE_EV3_FLAG|SYNC_PACKET_TYPE_NO_EV3_2_FLAG|SYNC_PACKET_TYPE_NO_EV3_3_FLAG|SYNC_PACKET_TYPE_NO_EV5_2_FLAG|SYNC_PACKET_TYPE_NO_EV5_3_FLAG
...
LMP_LIH_BV_107_C("dongle","usb","slave",10)