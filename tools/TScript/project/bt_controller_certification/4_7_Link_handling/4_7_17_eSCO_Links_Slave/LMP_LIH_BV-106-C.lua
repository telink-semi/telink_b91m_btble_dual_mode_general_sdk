...
function LMP_LIH_BV_106_C(iut_mode,lt_mode,role,Timeout)

    Testcase = "LMP/LIH/BV-106-C"
    -- iut_mode = "dongle"
    -- lt_mode  = "usb"
    OPTIONAL = ALT1
    print("--------------------<<   "..Testcase.."   >>--------------------")
    ...
    Packet_Type           = 0x03D8;     -- EV3/EV4 is allowed, SYNC_PACKET_TYPE_EV3_FLAG|SYNC_PACKET_TYPE_EV4_FLAG|SYNC_PACKET_TYPE_NO_EV3_2_FLAG|SYNC_PACKET_TYPE_NO_EV3_3_FLAG|SYNC_PACKET_TYPE_NO_EV5_2_FLAG|SYNC_PACKET_TYPE_NO_EV5_3_FLAG
...
--  <= IUT:HCI_Accept_Connection_Request
    if(flag==true and iut_mode~="unused") then
        Packet_Type = 0x03C8; --Accept EV3 packets
...
--  <= LT:wait for HCI_Synchronous_Connection_Complete Event
    ...
    Max_Latency           = 18;         --18ms
    Packet_Type           = 0x03D0;     --only EV4 is allowed, SYNC_PACKET_TYPE_EV4_FLAG|SYNC_PACKET_TYPE_NO_EV3_2_FLAG|SYNC_PACKET_TYPE_NO_EV3_3_FLAG|SYNC_PACKET_TYPE_NO_EV5_2_FLAG|SYNC_PACKET_TYPE_NO_EV5_3_FLAG
...
LMP_LIH_BV_106_C("dongle","usb","slave",10)