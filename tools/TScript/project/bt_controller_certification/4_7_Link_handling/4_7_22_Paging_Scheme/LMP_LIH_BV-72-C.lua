...
function  LMP_LIH_BV_72_C(iut_mode,lt_mode,role,Timeout)

	Testcase = "LMP/LIH/BV-72-C"
	-- iut_mode = "dongle"
	-- lt_mode  = "usb"
	-- role     = "slave"
	OPTIONAL = ALT1
	...
	print("============ need low tester start : LMP_page_scan_mode_req  =============")
...
for i=1,Total_times do
	...
	flag = LMP_LIH_BV_72_C("dongle","usb","slave",10)
	if(flag=="Pass") then
		success=success+1
	else
		fail=fail+1
