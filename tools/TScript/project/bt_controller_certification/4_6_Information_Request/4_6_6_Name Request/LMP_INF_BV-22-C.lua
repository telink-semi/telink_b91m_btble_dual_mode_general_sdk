...
function LMP_INF_BV_22_C(iut_mode,lt_mode,role,Timeout)

	Testcase = "LMP_INF_BV-22-C"
	-- iut_mode = "dongle"
	-- lt_mode  = "usb"
	-- role     = "slave"
	OPTIONAL = ALT1
	...
	HCI_Write_LE_Host_Support(iut_handle_w,iut_mode,le_sup,sim_le_host)
...
for i=1,Total_times do
	...
	flag = LMP_INF_BV_22_C("dongle","usb","slave",10)
