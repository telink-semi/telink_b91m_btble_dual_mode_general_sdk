...
function LMP_INF_BV_18_C(iut_mode,lt_mode,role,Timeout)

	Testcase = "LMP_INF_BV-18-C"
	-- iut_mode = "dongle"
	-- lt_mode  = "usb"
	-- role     = "slave"
	OPTIONAL = ALT1
    ...
    print("============ Upper and Lower Tester Supports SSP.===========")
	...
	-- HCI_Write_Secure_Connections_Host_Support(lt_handle_w,lt_mode,1)
...
for i=1,Total_times do
	...
	flag = LMP_INF_BV_18_C("dongle","usb","master",10)
