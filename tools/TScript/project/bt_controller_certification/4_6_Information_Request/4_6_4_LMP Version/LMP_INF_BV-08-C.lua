...
function LMP_INF_BV_08_C(iut_mode,lt_mode,role,Timeout)

	Testcase = "LMP_INF_BV-08-C"
	-- iut_mode = "dongle"
	-- lt_mode  = "usb"
	-- role     = "slave"
	OPTIONAL = ALT1
	...
	HCI_Read_Remote_Version_Information(lt_handle_w,lt_mode,lt_Connection_Handle)
	...
	-- => LT:HCI Command Status event
	flag,rst_tbl = HCI_Wait_Event_Done(lt_handle_r,lt_mode,"HCI_Read_Remote_Version_Information_Complete",Timeout)
	if(flag~=true) then
		Test_Status="Fail"
		goto Test_Case_End
	end
...
for i=1,Total_times do
	...
	flag = LMP_INF_BV_08_C("dongle","usb","slave",10)
