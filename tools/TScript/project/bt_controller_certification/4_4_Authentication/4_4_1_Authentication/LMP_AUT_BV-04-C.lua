...
require("project.bt_controller_certification.4_4_Authentication.DefaultSetting-Authentication")
...
function LMP_AUT_BV_04_C(iut_mode,lt_mode,role,Timeout)

	Testcase = "LMP/AUT/BV-04-C"
	-- iut_mode = "dongle"
	-- lt_mode  = "usb"
	-- role     = "slave"
	OPTIONAL = ALT1
	...
	initial_authen = 1  
	-- Default Settings
	flag = Default_Setting(iut_handle_r, iut_handle_w,iut_mode,role,initial_authen,Timeout)
...
for i=1,Total_times do
	...
	flag = LMP_AUT_BV_04_C("dongle","usb","master",10)
