...
function  BB_PHYS_INQ_BV_18_C(iut_mode,lt_mode,role,Timeout)

	Testcase = "BB/PHYS/INQ/BV-18-C"
	-- iut_mode = "dongle"
	-- lt_mode  = "usb"
	-- role     = "slave"
	OPTIONAL = ALT1
...
-- <= IUT:HCI_Set_Event_Mask
    ...
    print("============ first loop need lt set eir=0 =============")
	for i=1,10 do

-- <= iut:HCI Inquiry
	LAP= 0x9e8b33
	Inquiry_Length = 0x08  -- 10*1.28s=12.8s
	Num_Responses  = 1
...
-- => iut:HCI Inquiry Complete event
	...
	print("============ first loop need lt set eir=1 =============")
	for i=1,10 do
...
for i=1,Total_times do
	...
	flag = BB_PHYS_INQ_BV_18_C("dongle","usb","slave",10)
	if(flag=="Pass") then
		success=success+1
	else
		fail=fail+1
