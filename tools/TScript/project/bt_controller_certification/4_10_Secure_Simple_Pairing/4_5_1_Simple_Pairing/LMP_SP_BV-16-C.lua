...
function LMP_SP_BV_16_C(iut_mode,lt_mode,role,Timeout)

	Testcase = "LMP/SP/BV-16-C"
	-- iut_mode = "dongle"
	-- lt_mode  = "usb"
	-- role     = "slave"
	OPTIONAL = ALT1
	...
	lt_rst_tbl.PassKey[1] = lt_rst_tbl.PassKey[1] + 1
...
for i=1,Total_times do
	...
	flag = LMP_SP_BV_16_C("dongle","usb","master",10)
...
for i=1,Total_times do
	...
	flag = LMP_SP_BV_16_C("dongle","usb","slave",10)
