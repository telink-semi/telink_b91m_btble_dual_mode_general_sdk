...
function LMP_SP_BV_22_C(iut_mode,lt_mode,role,Timeout)

	Testcase = "LMP/SP/BV-22-C"
	-- iut_mode = "dongle"
	-- lt_mode  = "usb"
	-- role     = "slave"
	OPTIONAL = ALT1
	...
	Encryption_Enable = 1;
	HCI_Set_Connection_Encryption(iut_handle_w,iut_mode,iut_Connection_Handle,Encryption_Enable)
	-- => LT:HCI Command Status event
	flag,rst_tbl = HCI_Wait_Event_Done(iut_handle_r,iut_mode,"HCI_Command_Status",Timeout)
	if(flag~=true) then
		Test_Status="Fail"
...
for i=1,Total_times do
	...
	flag = LMP_SP_BV_22_C("dongle","usb","master",10)
