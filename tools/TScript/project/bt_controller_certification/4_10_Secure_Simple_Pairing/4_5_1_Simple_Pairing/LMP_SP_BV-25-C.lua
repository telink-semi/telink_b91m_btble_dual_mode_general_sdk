...
function LMP_SP_BV_25_C(iut_mode,lt_mode,role,Timeout)

	Testcase = "LMP/SP/BV-25-C"
	-- iut_mode = "dongle"
	-- lt_mode  = "usb"
	-- role     = "slave"
	OPTIONAL = ALT1
	...
	HCI_Remote_OOB_Data_Request_Reply(iut_handle_w, iut_mode, iut_rst_tbl.BD_ADDR,lt_oob_commitment,error_oob_random)
	-- => IUT:HCI Command Complete event
	flag,rst_tbl = HCI_Wait_Event_Done(iut_handle_r,iut_mode,"HCI_Command_Complete",Timeout)
	if(flag~=true) then
		Test_Status="Fail"
...
for i=1,Total_times do
	...
	flag = LMP_SP_BV_25_C("dongle","usb","master",10)
