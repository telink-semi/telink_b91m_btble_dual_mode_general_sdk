...
function LMP_SP_BV_28_C(iut_mode,lt_mode,role,Timeout)

	Testcase = "LMP/SP/BV-28-C"
	-- iut_mode = "dongle"
	-- lt_mode  = "usb"
	-- role     = "slave"
	OPTIONAL = ALT1
	...
	HCI_Write_Simple_Pairing_Debug_Mode(iut_handle_w,iut_mode,sp_debug_mode)
	-- => LT:HCI Command Status event
	flag,rst_tbl = HCI_Wait_Event_Done(iut_handle_r,iut_mode,"HCI_Command_Complete",Timeout)
	if(flag~=true) then
		Test_Status="Fail"
...
for i=1,Total_times do
	...
	flag = LMP_SP_BV_28_C("dongle","usb","master",10)
...
for i=1,Total_times do
	...
	flag = LMP_SP_BV_28_C("dongle","usb","slave",10)
