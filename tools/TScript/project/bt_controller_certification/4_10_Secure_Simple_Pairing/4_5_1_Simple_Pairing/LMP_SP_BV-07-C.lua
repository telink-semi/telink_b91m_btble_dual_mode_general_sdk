...
function LMP_SP_BV_07_C(iut_mode,lt_mode,role,Timeout)

	Testcase = "LMP/SP/BV-07-C"
	-- iut_mode = "dongle"
	-- lt_mode  = "usb"
	-- role     = "slave"
	OPTIONAL = ALT1
	...
	HCI_User_Confirmation_Request_Reply(lt_handle_w, lt_mode, rst_tbl.BD_ADDR)
...
for i=1,Total_times do
	...
	flag = LMP_SP_BV_07_C("dongle","usb","master",10)
...
for i=1,Total_times do
	...
	flag = LMP_SP_BV_07_C("dongle","usb","slave",10)
