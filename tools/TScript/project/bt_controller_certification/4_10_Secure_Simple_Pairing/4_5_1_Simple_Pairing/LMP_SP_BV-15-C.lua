...
function LMP_SP_BV_15_C(iut_mode,lt_mode,role,Timeout)

	Testcase = "LMP/SP/BV-15-C"
	-- iut_mode = "dongle"
	-- lt_mode  = "usb"
	-- role     = "slave"
	OPTIONAL = ALT1
	...
	HCI_User_Passkey_Request_Negative_Reply(lt_handle_w, lt_mode, rst_tbl.BD_ADDR)
...
for i=1,Total_times do
	...
	flag = LMP_SP_BV_15_C("dongle","usb","master",10)
...
for i=1,Total_times do
	...
	flag = LMP_SP_BV_15_C("dongle","usb","slave",10)
