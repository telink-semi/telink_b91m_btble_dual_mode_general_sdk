...
function LMP_SP_BV_11_C(iut_mode,lt_mode,role,Timeout)

	Testcase = "LMP/SP/BV-11-C"
	-- iut_mode = "dongle"
	-- lt_mode  = "usb"
	-- role     = "slave"
	OPTIONAL = ALT1
	...
	-- <= LT:HCI_User_Confirmation_Request_Reply
	HCI_User_Confirmation_Request_Negative_Reply(iut_handle_w, iut_mode, rst_tbl.BD_ADDR)
...
for i=1,Total_times do
	...
	flag = LMP_SP_BV_11_C("dongle","usb","master",10)
...
for i=1,Total_times do
	...
	flag = LMP_SP_BV_11_C("dongle","usb","slave",10)
