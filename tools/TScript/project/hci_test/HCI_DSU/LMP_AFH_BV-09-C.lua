...
print("============LMP/AFH/BV-09-C [Slave device does not send a LMP_Set_AFH PDU -after successful master slave switch]=============")
...
if (role_change_fail == 0) then
    sleep_cnt = 1;
    --waits for the 60s and vefifies that the IUT does not transmit an LMP_set_AFH 
