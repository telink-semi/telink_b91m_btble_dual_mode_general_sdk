...
function  EVENT_HCI_Command_Complete(tbl,mode)
	...
	-- common completion evt, show opcode and status here 
	str_out=string.format("<EVT_COMMON_CMD_CC:>status=0x%02x, opcode=0x%04x, num=%d",
	rst_tbl.Return_Parameters[1], rst_tbl.Command_Opcode, rst_tbl.Num_HCI_Command_Packets);
	print(str_out);
...
function  EVENT_HCI_Command_Status(tbl,mode)
	...
	-- common status evt, show opcode and status here 
	str_out=string.format("<EVT_COMMON_CMD_STA:>status=0x%02x, opcode=0x%04x, num=%d",
	rst_tbl.Status, rst_tbl.Command_Opcode, rst_tbl.Num_HCI_Command_Packets);
	print(str_out);
