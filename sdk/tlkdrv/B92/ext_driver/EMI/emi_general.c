...
//		gpio_output_en(GPIO_PD1);
//		gpio_input_dis(GPIO_PD1);
...
//		gpio_set_level(GPIO_PE7,0);
	...
	{
		analog_write_reg8(0x0a, (analog_read_reg8(0x0a) & 0xfc) | DCDC_1P4_LDO_2P0);
	    //		gpio_set_level(GPIO_PD1,1);
	}
	else if(g_emi_setting.general_setting.power_mode == 2)
	{
		analog_write_reg8(0x0a, (analog_read_reg8(0x0a) & 0xfc) | DCDC_1P4_DCDC_2P0);
//		gpio_set_level(GPIO_PD0,1);
	}
	else
	{
		analog_write_reg8(0x0a, (analog_read_reg8(0x0a) & 0xfc) | LDO_1P4_LDO_2P0);
