...
_attribute_ram_code_sec_optimize_o2_ void pm_sleep_start(pm_sleep_mode_e sleep_mode);
...
/**
 * @brief		Calculate the offset value based on the difference of conn_offset_tick&rc32_cnt.
 * @param[in]	offset_tick	- .
 * @param[in]	rc32_cnt	- .
 * @return		none.
 */
...
#define PM_MIN_SLEEP_US			1500  //B92 todo
 ...
 void ext_sys_init(power_mode_e power_mode, vbat_type_e vbat_v, gpio_voltage_e gpio_v);
