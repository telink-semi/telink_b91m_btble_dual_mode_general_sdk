...
//	.uart_rx = BQB_UART_RX_PORT,
	.pa_addr = 0,
	.flash = FLASH_SIZE_512K,
	.cal_pos = 1,
	.power_mode = LDO_1P4_LDO_1P8,
//	.power = BQB_TX_POWER,
	.cap = 1,
...
void rd_usr_definition(unsigned char _s)
{
	if(_s)
	{
		...
		if(get_config_data(TLK_CONFIG_TYPE_BQB, (unsigned char*)&bqb_cfg_data, sizeof(bqb_cfg_data)))
		{
			...
			{
			case 0:
				g_bqb_setting.power_mode = LDO_1P4_LDO_1P8;
				break;
			case 1:
				g_bqb_setting.power_mode = DCDC_1P4_LDO_1P8;
				break;
			case 2:
				g_bqb_setting.power_mode = DCDC_1P4_DCDC_1P8;
				break;
			default:
				break;
			}
